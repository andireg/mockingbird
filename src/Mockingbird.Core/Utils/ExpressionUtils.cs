...
internal static class ExpressionUtils
{
    ...
    private static readonly Type JsonSerializerType = typeof(JsonSerializer);
    ...
    private static readonly MethodInfo JsonSerializerSerializeObjectMethodInfo = JsonSerializerType.GetMethodInfo("Serialize(Object,Type,JsonSerializerOptions)");
        ...
        object? referenceValue)
    {
        ...
        {
            referenceValueExpression = Expression.Constant(referenceValue == null ? null : JsonSerializer.Serialize(referenceValue!));
            currentValueExpression = Expression.Call(
                JsonSerializerSerializeObjectMethodInfo, 
